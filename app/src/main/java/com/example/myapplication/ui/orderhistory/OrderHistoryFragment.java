...
public class OrderHistoryFragment extends Fragment {
    ...
    private void setupObservers() {
        ...
        orderHistoryViewModel.getOrderHistory().observe(getViewLifecycleOwner(), orders -> {
        ...
        orderHistoryViewModel.getIsLoading().observe(getViewLifecycleOwner(), isLoading -> {
            binding.progressBar.setVisibility(isLoading ? View.VISIBLE : View.GONE);
        });

        // Observe error
        orderHistoryViewModel.getError().observe(getViewLifecycleOwner(), error -> {
    ...
    private void setupClickListeners() {
        binding.ivRefresh.setOnClickListener(v -> {
            orderHistoryViewModel.refreshOrderHistory();
        });
    }
